<x-layouts.guest title="Lupa Password">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 py-16">
        <div class="text-center mb-8">
            ...
            <h1 class="mt-6 text-3xl sm:text-4xl font-extrabold text-gray-900">Lupa Login ID atau Password?</h1>
        </div>

        <x-card class="p-6 sm:p-8 space-y-6">
            <div>
                <h2 class="text-xl font-bold text-gray-900 mb-2">Lupa Login ID?</h2>
                <p class="text-lg text-gray-700 leading-relaxed">
                    Login ID Anda adalah nama lengkap tanpa spasi (huruf kecil semua).
                    Jika ada warga lain dengan nama yang sama, Login ID Anda mendapat tambahan angka di belakang.
                </p>
                <p class="text-lg text-gray-700 leading-relaxed mt-2">
                    Contoh: nama <strong>Budi Santoso</strong> &rarr; Login ID <strong>budisantoso</strong> (atau <strong>budisantoso2</strong> jika sudah ada yang memakai).
                </p>
            </div>
